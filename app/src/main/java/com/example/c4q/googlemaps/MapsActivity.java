...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getting access to a static method, which is going to give us a resource and we're doing it by passing context
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng c4q =new LatLng(40.7429595, -73.94192149999998);
        mMap.addMarker(new MarkerOptions().position(c4q).title("Marker in C4Q").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_round)));
